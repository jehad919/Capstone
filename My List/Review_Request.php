        ...
        <div class="container">
            ...
            <div class="button-container">
                ...
                function addToWishlist() {
                    alert('Service added to your wish list!');
                    console.log("wishlist");
                }
                   </script>

                <button class="button" onclick="addToWishlist()">Add to my wish list</button>
                <button class="button" onclick="window.location.href='./SubmitForm.php?service_id=<?php echo $serviceDetails['ID']; ?>';">Submit</button>
            </div>
        </div>
