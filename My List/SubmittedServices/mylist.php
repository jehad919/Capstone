...
$sql = "SELECT * FROM services WHERE creator = '$username' AND status = 'submited'";
...
<body>
  ...
  <section class="hero-section">
    ...
    <button class="list-button" onclick="window.location.href='../mylist.php'">Requested Services</button>
    <button class="list-button" onclick="window.location.href='../ActiveServices/mylist.php'">Active Services</button>
    <button class="list-button active" onclick="window.location.href='mylist.php'">Submitted</button>
    ...
    <?php foreach ($serviceData as $service): ?>
      ...
      <a href="../Review_Request.php?service_id=<?php echo $service['ID']; ?>" class="card-link">
